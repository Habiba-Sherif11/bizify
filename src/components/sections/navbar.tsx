        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-18 relative">
            ...
            >
              ...
              <span className="text-2xl md:text-[1.75rem] font-semibold text-neutral-900" style={{ fontFamily: 'var(--font-cormorant-sc)' }}>
                Bizify
              </span>
            </Link>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-6 border-b border-neutral-200">
            ...
            >
              ...
              <span className="text-2xl font-semibold text-neutral-900" style={{ fontFamily: 'var(--font-cormorant-sc)' }}>Bizify</span>
            </Link>
            <Button
              onClick={() => setIsMenuOpen(false)}
              variant="ghost"
