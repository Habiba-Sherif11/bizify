...
// Easy to edit: just add/remove items
const features = [
...
// Easy to edit: just add/remove plans
const plans = [
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="hidden lg:block overflow-x-auto -mx-4 px-4">
          <table className="w-full border-collapse" style={{ minWidth: 720 }}>
                  ...
                  <th key={plan.key} className="pb-0 px-1.5 align-bottom text-left" style={{ width: "16.5%" }}>
                    ...
                    >
                      ...
                      <div className="flex items-baseline gap-0.5 mt-1 mb-3">
                        <span className="text-neutral-900" style={{ fontSize: "1.75rem", fontWeight: 700, lineHeight: 1 }}>
            ...
            <tbody>
              {/* spacer row */}
              <tr><td className="h-4" colSpan={5} /></tr>
                  ...
                  {plans.map((plan) => {
                    ...
                    return (
                      <td key={plan.key} className="py-3 px-2 text-center">
                        {value ? (
                          <Check size={16} strokeWidth={2.5} style={{ color: plan.popular ? "#FB8500" : plan.color }} />
                        ) : (
              ...
              <div className="space-y-3 border-t border-neutral-100 pt-6">
                {features.map((feature) => (
                  <div key={feature.name} className="flex items-start gap-2">
                    {feature[plan.key] ? (
                      <Check size={16} strokeWidth={2.5} className="mt-0.5 flex-shrink-0" style={{ color: plan.color }} />
                    ) : (
                      <Minus size={14} strokeWidth={1.5} className="text-neutral-300 mt-0.5 flex-shrink-0" />
                    )}
                    <span
                      className={`text-sm ${
        ...
        <div className="mt-16 relative">
          ...
          >
            {/* Subtle blurred accent inside CTA */}
            <div
