...
export function HeroMockup({ imageSrc, imageAlt = "Bizify Dashboard" }: HeroMockupProps) {
  return (
    <div className="w-full flex justify-center">
      <div style={{ width: "100%", maxWidth: "800px", aspectRatio: "800/544.81", position: "relative" }}>
        {/* Blur layer 1 */}
        <div
          style={{
            width: "88.49%",
        ...
        {/* Image content - FIXED: Now using imageSrc prop */}
        <div
          style={{
            width: "99.98%",
            height: "94.49%",
        ...
        >
          <Image
            src={imageSrc}  // ✅ Fixed: Now using the prop
            alt={imageAlt}
            fill
