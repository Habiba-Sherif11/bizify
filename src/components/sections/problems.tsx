...
export function ProblemsSection() {
  return (
    <section id="problems" className="relative min-h-[88svh] px-4 py-14 sm:px-6 sm:py-16 lg:px-8 flex items-center">
      <div className="relative z-10 w-full max-w-5xl mx-auto">
        {/* Section Header */}
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-block px-4 py-1.5 mb-6 bg-white border border-amber-500 rounded-full">
            <span className="text-xs font-semibold text-amber-500 uppercase tracking-wide">The Problem</span>
          </div>
